...
class BuzzIndicator(Gtk.Dialog):
    ...
    def __init__(self, player: Player, parent: Gtk.Window):
        ...
        self.get_content_area().add(Gtk.Label(label=player.name + " has buzzered"))
    ...
    def placeAtBottomRightOf(self, otherWindow: Gtk.Window) -> None:
