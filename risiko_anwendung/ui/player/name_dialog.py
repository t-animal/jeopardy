...
class PlayerNameDialog(Gtk.Dialog):
    ...
    def __init__(self, parent: Gtk.Window, playerKey: str, playerName: str = ""):
        Gtk.Dialog.__init__(self, title="Welcome, Player!", transient_for=parent)
        self.set_modal(True)
    ...
    def getName(self) -> str:
        return str(self.nameEntry.get_text())
